...
public class MainActivityMH5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_mh5);
        ...
        btnkq.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(MainActivityMH5.this,"Chính xác",Toast.LENGTH_LONG).show();
                    a = (int) (Math.random()*5);
                    b = (int) (Math.random()*5);
                    kqdung = a+b;
                    ...
                    Toast.makeText(MainActivityMH5.this,"Sai rồi",Toast.LENGTH_LONG).show();
