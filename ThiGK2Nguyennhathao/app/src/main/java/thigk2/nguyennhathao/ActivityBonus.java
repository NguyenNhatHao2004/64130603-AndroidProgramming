...
public class ActivityBonus extends AppCompatActivity {
    int a,b,kqdung;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnkq.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(ActivityBonus.this,"Chính xác",Toast.LENGTH_LONG).show();
                    a = (int) (Math.random()*5);
                    b = (int) (Math.random()*5);
                    kqdung = a+b;
                    ...
                    Toast.makeText(ActivityBonus.this,"Sai rồi",Toast.LENGTH_LONG).show();
